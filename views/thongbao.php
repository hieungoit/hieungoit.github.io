...
if(isset($_SESSION['ten_dang_nhap']) and isset($_POST['action']) )
{
  if($_POST['action'] === "insert")
    {
        include './../server/insert_thong_bao.php';
        if($result == 1)
    {
...
{
    include("./../server/update_thong_bao.php");
    if($result == 1)
    {
		...
		<div class="row">
			<div class="col-md-12">
				<div class="sidebar sidebar-fixed" >
					<ul class="list-group">						
						<li class="list-group-item"><a class="active" href=""><i class="fa fa-home"></i>Bảng tin</a></li>
            ...
            <div class="content">
                ...
                <h2>Bảng tin</h2>
                 ...
                 <?php  include("./../server/admin/select_qr.php");
            
              
                 while ($qr=mysqli_fetch_array($stms)) {

                 
                ?>

                <h4 style="color: blue;">Mã  lớp : <?php echo $qr['ma_lop_hoc'] ?> </h4>
                 <?php }?>
                <?php 
                 if($auth['loai_tai_khoan'] == "GV" or $auth['loai_tai_khoan'] == "AD"){
                    echo ' <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModalCenter">Thêm bảng tin</button>';
                 }
                ?>
            </div>
            <br>
               ...
               <table class="table table-hover">
                 ...
                 <?php
                  ...
                  ?>
                   ...
                   <tbody>
                    <?php  include("./../server/admin/select_thong_bao.php");
                ...
                ?>
                       ...
                       <tr>
                           ...
                           <td style type="file" media="screen">
                            ...
                            <a href="<?= $row['file_bai_tap'] ?>" download="">download</a></td>
                           <td>
                        ...
                        <?php  
                          ...
                          {   
                              ...
                              <a class="btn btn-success" onclick="edittt('.$row['id_bai_tap'].')" >Sửa</a>
                            ...
                            ?>
                          <?php 
                             echo '<a href="chitietthongbao.php?id_bai_tap='.$row['id_bai_tap'].'&id='.$_GET['id'].'" class="btn btn-primary">Chi tiết</a>'
                                         ?>
                                        </td>
                       </tr>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-body">
                ...
                <br>
                <input type="file" class="form-control" placeholder="file" name="file_bai_tap">
                <br>      
            </div>
...
<div class="modal fade" id="updatett" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Thêm lớp</h5>
