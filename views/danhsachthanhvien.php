        ...
        <div class="row">
			...
			<div class="col-md-12">
				<div class="sidebar sidebar-fixed" >
                 ...
                 <li class="list-group-item"><a href="xacnhan.php?id=<?= $_GET['id'] ?>"><i class="fa fa-check" aria-hidden="true"></i>Xác nhận</a></li>
                 <li class="list-group-item"><a class="active" href=""><i class="fa fa-list" aria-hidden="true"></i>Danh sách</a></li>
           ...
           <div class="table-responsive">
               <table class="table table-hover">
                   ...
                   <?php
                    $id_lop_hoc = $_GET['id'];
                    $sql = "SELECT dang_nhap.ho_ten , id_thanh_vien, dang_nhap.ngay_sinh, dang_nhap.email , dang_nhap.so_dien_thoai FROM `thanh_vien`, `dang_nhap`  WHERE thanh_vien.id_lop_hoc=$id_lop_hoc and trang_thai=1 and thanh_vien.ten_dang_nhap = dang_nhap.ten_dang_nhap " ;
                   ...
                   if(mysqli_num_rows($stms) > 0)
               {
                ...
                ?>
                       <tr>
                           ...
                           <td>
                           <a onclick = "disagree(<?php echo $row['id_thanh_vien'] ?>)" class="btn btn-danger" >Xóa</a>
